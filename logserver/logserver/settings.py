...
DEBUG = False
ALLOWED_HOSTS = ['numatrace.numatixsolutions.com', 'localhost', '127.0.0.1','94.136.191.209:8010']
CSRF_TRUSTED_ORIGINS = ['numatrace.numatixsolutions.com','localhost', '127.0.0.1','94.136.191.209:8010']
REST_FRAMEWORK = {
...
CRONJOBS = [
   ('*/1 * * * *', 'logserver.cron.hourly_task_detailed')
]
TEMPLATES = [
    {
